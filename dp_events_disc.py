...
#%%
t_SR, t_GW, h_Tilde, fGW_dot, F_peak, M_peak = get_hTilde_peak(bc, alpha_grid, MList, aList, d_crit)
...
for i_h, hVal in enumerate(hList):
    ...
    dfdlogh_disc[i_h+1, 1] = norm_disc*get_dfdlogh_disc(mu, eps, M_peak, alpha_grid, t_SR, t_GW, h_Tilde, MList, aList, hVal, 
                                                        fGW_dot, fdot_range[i_fGW], epsSq_fr*F_peak, FTh,
