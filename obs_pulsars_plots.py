...
for i in range(ntot):
    list_temp = np.load('data/pulsars_events/dfdlogh_disc_NB_5_30_0_1_'+str(i)+'.npy')
    freq_GW[i] = list_temp[0, 1]
    dfdlogF.append(list_temp[1:])
    list_temp = np.load('data/pulsars_events/dfdlogh_disc_NB_5_20_0_1_'+str(i)+'.npy')
    freq_GW[i] = list_temp[0, 1]
    dfdlogF_lowmass.append(list_temp[1:])
    list_temp = np.load('data/pulsars_events/dfdlogh_disc_NB_5_30_0_0.5_'+str(i)+'.npy')
    freq_GW[i] = list_temp[0, 1]
    dfdlogF_lowspin.append(list_temp[1:])
    list_temp = np.load('data/pulsars_events/dfdlogh_disc_NB_5_20_0_0.3_'+str(i)+'.npy')
    freq_GW[i] = list_temp[0, 1]
...
fig.tight_layout()
fig.savefig('figs/flux_dist_disc.pdf', bbox_inches="tight")
#%%
...
fig.tight_layout()
fig.savefig('figs/flux_cumulative_disc.pdf', bbox_inches="tight")
#%%